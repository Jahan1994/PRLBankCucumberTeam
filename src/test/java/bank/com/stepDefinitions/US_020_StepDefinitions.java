...
//  }
        ...
        WriteAndReadText.saveDataInFileWithAllCustomerInfo("src\\test\\resources\\test_data\\customerFromAPI", customer);

        List<Customer> actualCustomerList = WriteAndReadText.returnAWholeCostumer("src\\test\\resources\\test_data\\customerFromAPI");
        ...
        for (int j = 0; j < expectedList.size(); j++) {
            ...
            for (Customer each : actualCustomerList) {
                System.out.println("Actual data"+each);
